 ...
 */
let SendProvider = exports.SendProvider = class SendProvider {
    static value() {
...
let SendResponseMiddlewareProvider = exports.SendResponseMiddlewareProvider = class SendResponseMiddlewareProvider {
    value() {
